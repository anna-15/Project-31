...
function setup(){
    ...
    plinko1 = new Plinko(63,50,10);
    plinko2 = new Plinko(114,50,10);
    plinko3 = new Plinko(163,50,10);
    plinko4 = new Plinko(214,50,10);
    plinko5 = new Plinko(264,50,10);
    plinko6 = new Plinko(315,50,10);
    plinko7 = new Plinko(366,50,10);
    plinko8 = new Plinko(416,50,10);
    ...
    plinko37 = new Plinko(63,370,10);
    plinko38 = new Plinko(116,370,10);
    plinko39 = new Plinko(166,370,10);
    plinko40 = new Plinko(216,370,10);
    plinko41 = new Plinko(266,370,10);
    plinko42 = new Plinko(317,370,10);
    plinko43 = new Plinko(366,370,10);
    plinko44 = new Plinko(416,370,10);
    plinko45 = new Plinko(12,455,10);
    plinko46 = new Plinko(63,455,10);
    plinko47 = new Plinko(116,455,10);
    plinko48 = new Plinko(167,455,10);
    plinko49 = new Plinko(218,455,10);
    plinko50 = new Plinko(267,455,10);
    plinko51 = new Plinko(317,455,10);
    plinko52 = new Plinko(367,455,10);
    plinko53 = new Plinko(417,455,10);
    plinko54 = new Plinko(467,455,10);
